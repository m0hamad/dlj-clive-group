...
const Overview = () => {
    return (
        <>
            ...
            <br />
            <h4>The General Research Area</h4>
            <p>The Clive Research team studies a wide range of synthetic projects dealing with the construction of complex natural products with important medical properties and the development of new reactions and reagents.</p>
            <br />
            ...
            <br />
            <h4>Current Synthetic Targets</h4>
            <p>Several Group Members are presently involved in the synthesis of some complex natural products having properties that make them relevant to the treatment of serious diseases. The synthesis of these compounds is likely to lead to the invention of new chemistry, as was the case with the targets already completed.</p>
            <br />
            <h4>Current Methodology</h4>
            <p>Several methodology projects are under investigation aimed mainly at inventing new methods for making carbon-carbon bonds and for assembly of very large bioactive peptides.</p>
        </>
    )
}
